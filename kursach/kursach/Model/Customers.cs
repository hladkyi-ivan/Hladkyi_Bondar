...
namespace kursach.Model
{
    ...
    public class Customer
    {
        ...
        { FirstName = firstName; SecondName = lastName; PhoneNumber = phoneNumber; NickName = nickName; Password = password; AvatarPath = "pack://application:,,,/Images/Без_названия-removebg-preview.png"; LikedTickets = new List<Ticket>(); }
